public class Temperature_converter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(255, 193, 37));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24));
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Konvertor temperatre");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Celzij", "Farhajt" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Celzij", "Farhajt" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        else if(val1.equals("Farhajt") && val2.equals("Farhajt"))
        {
            double f = Double.parseDouble(jTextField1.getText());
